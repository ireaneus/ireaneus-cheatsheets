...
tcpdump -i eth0 'port 8052 or port 8056' -w file.pcap
...
# write to a file and capture tcp traffic to a destination IP
# tcpdump -w ~/0001.pcap -i eth0 dst 10.192.4.11
```